      ...
      <nav className="z-[100] relative flex items-center px-[10vw] bg-transparent">
        <div className="mx-auto flex w-full items-center ">
          <div className="w-[50%] relative lg:text-left block flex items-center">
            <a className="cursor-pointer h-[3rem] opacity-[.8] hover:opacity-[1] hover:shadow-gold duration-1000 flex border-[1px] rounded-lg border-[#d8b15d]">
              <LightSVG />
              <span className="Alumni mr-[.7rem] block my-auto sm:inline-block hidden text-[#d8b15d] duration-[500ms] rounded-lg mx-auto durarion-600 text-right text-[1.5rem] text-shadow">
                SEIFELELAM
              </span>
            </a>
          </div>
